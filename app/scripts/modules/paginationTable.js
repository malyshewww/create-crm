...
function getPagination(table) {
	let lastPage = 1;
	// let maxRows = document.getElementById('maxRows');
	// let pagination = document.querySelector('.pagination');
	// maxRows.addEventListener('change', () => {
	// 	lastPage = 1;
	// 	pagination.querySelector('li').slice(1, -1).remove();
	// 	let trnum = 0;
	...
	// 	document.querySelector('.pagination [data-page="1"]').classList.add('active') // add active class to the first li
	// })
	$('#maxRows')
